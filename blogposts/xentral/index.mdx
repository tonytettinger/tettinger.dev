...
We have iteratively worked with the UX and Product Team with a tight deadline, creating a well structured, maintainable page that gives the editors freedom to modify the modular blocks and component styles directly from the CMS.
