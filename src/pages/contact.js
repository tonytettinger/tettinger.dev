...
import { 
  FormControl,
  FormLabel,
  Textarea, Input, Heading, Button, VStack } from "@chakra-ui/react";
...
const ContactPage = () => {
  return (
    ...
    <FormControl>
      ...
      <Textarea size="lg" form="contactform" id='message' type='text' name='message' placeholder="Your message" />
    </FormControl>

      <Button colorScheme="gray" variant="outline" mt={4} type="submit">Send</Button>
  </form>
  </VStack>
  )
}
